...
namespace MyComplexNumber{
	...
	{
		/*
		Use the half angle relation to calculate the square root. Prevents
		buffer over/under flows. Don't change this code. This problem actually
		occurs
		*/
		double mag;
		double theta;
	...
	{
		/*
		 While inefficient, this prevents buffer under/overflows - from
